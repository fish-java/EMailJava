...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        String myEmailAccount = "1251554146@qq.com";
        String myEmailPassword = "lcwmixlnzopmgbji";
        ...
        // 收件人邮箱（替换为自己知道的有效邮箱）
        //String receiveMailAccount = "1251554146@qq.com";
        String receiveMailAccount = "bitfish666@outlook.com";
